...
type SendBadDebtNotifyResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Base          *BaseResponse          `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"` // 基础响应
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SendBadDebtNotifyResp) Reset() {
	*x = SendBadDebtNotifyResp{}
	mi := &file_fund_v1_fund_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SendBadDebtNotifyResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendBadDebtNotifyResp) ProtoMessage() {}

func (x *SendBadDebtNotifyResp) ProtoReflect() protoreflect.Message {
	mi := &file_fund_v1_fund_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendBadDebtNotifyResp.ProtoReflect.Descriptor instead.
func (*SendBadDebtNotifyResp) Descriptor() ([]byte, []int) {
	return file_fund_v1_fund_proto_rawDescGZIP(), []int{17}
}

func (x *SendBadDebtNotifyResp) GetBase() *BaseResponse {
	if x != nil {
		return x.Base
	}
	return nil
...
const file_fund_v1_fund_proto_rawDesc = "" +
	...
	"\n" +
	"\b_user_id\"B\n" +
	"\x15SendBadDebtNotifyResp\x12)\n" +
	"\x04base\x18\x01 \x01(\v2\x15.fund.v1.BaseResponseR\x04base\"M\n" +
...
var file_fund_v1_fund_proto_goTypes = []any{
	...
	(*SendBadDebtNotifyResp)(nil),      // 17: fund.v1.SendBadDebtNotifyResp
	(*GetUserBalanceReq)(nil),          // 18: fund.v1.GetUserBalanceReq
	(*GetUserBalanceResp)(nil),         // 19: fund.v1.GetUserBalanceResp
	(*UserBalanceInfo)(nil),            // 20: fund.v1.UserBalanceInfo
	(*GameTransactionReq)(nil),         // 21: fund.v1.GameTransactionReq
	(*TransactionReqInfo)(nil),         // 22: fund.v1.TransactionReqInfo
	(*GameTransactionResp)(nil),        // 23: fund.v1.GameTransactionResp
	(*TransactionData)(nil),            // 24: fund.v1.TransactionData
	(*TransferStatusUpdateReq)(nil),    // 25: fund.v1.TransferStatusUpdateReq
	(*TransferStatusUpdateResp)(nil),   // 26: fund.v1.TransferStatusUpdateResp
	(*TransferStatusUpdateData)(nil),   // 27: fund.v1.TransferStatusUpdateData
