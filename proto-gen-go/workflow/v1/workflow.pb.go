...
const file_workflow_v1_workflow_proto_rawDesc = "" +
	"\n" +
	"\x1aworkflow/v1/workflow.proto\x12\vtemporal.v1\"\r\n" +
	"\vWorkflowReq\"\x0e\n" +
	"\fWorkflowResp2S\n" +
	"\x14WorkflowInnerService\x12;\n" +
	"\x04Test\x12\x18.temporal.v1.WorkflowReq\x1a\x19.temporal.v1.WorkflowRespB8Z6github.com/og-game/game-proto/proto-gen-go/workflow/v1b\x06proto3"
...
var file_workflow_v1_workflow_proto_goTypes = []any{
	(*WorkflowReq)(nil),  // 0: temporal.v1.WorkflowReq
	(*WorkflowResp)(nil), // 1: temporal.v1.WorkflowResp
}
var file_workflow_v1_workflow_proto_depIdxs = []int32{
	0, // 0: temporal.v1.WorkflowInnerService.Test:input_type -> temporal.v1.WorkflowReq
	1, // 1: temporal.v1.WorkflowInnerService.Test:output_type -> temporal.v1.WorkflowResp
