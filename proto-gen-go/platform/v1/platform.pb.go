...
type GetGameLinkReq struct {
	...
	MerchantUserId  string                 `protobuf:"bytes,15,opt,name=merchant_user_id,json=merchantUserId,proto3" json:"merchant_user_id,omitempty"` // 商户用户id
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *GetGameLinkReq) GetMerchantUserId() string {
	if x != nil {
...
type GetBetRecordListReq struct {
	...
	History       bool                   `protobuf:"varint,5,opt,name=history,proto3" json:"history,omitempty"`                      // 是否获取历史记录
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetBetRecordListReq) GetHistory() bool {
	if x != nil {
		return x.History
	}
	return false
...
func (x *GameSabaStatusReq) Reset() {
	*x = GameSabaStatusReq{}
...
func (x *GameSabaStatusReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameSabaStatusReq) ProtoMessage() {}

func (x *GameSabaStatusReq) ProtoReflect() protoreflect.Message {
	mi := &file_platform_v1_platform_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameSabaStatusReq.ProtoReflect.Descriptor instead.
func (*GameSabaStatusReq) Descriptor() ([]byte, []int) {
	return file_platform_v1_platform_proto_rawDescGZIP(), []int{18}
}

func (x *GameSabaStatusReq) GetRefId() []string {
	if x != nil {
		return x.RefId
	}
	return nil
...
type GameSabaStatusResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GameSabaStatusResp) Reset() {
	*x = GameSabaStatusResp{}
	mi := &file_platform_v1_platform_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GameSabaStatusResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameSabaStatusResp) ProtoMessage() {}

func (x *GameSabaStatusResp) ProtoReflect() protoreflect.Message {
	mi := &file_platform_v1_platform_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameSabaStatusResp.ProtoReflect.Descriptor instead.
func (*GameSabaStatusResp) Descriptor() ([]byte, []int) {
	return file_platform_v1_platform_proto_rawDescGZIP(), []int{19}
}

type GameSabaRetryCheckReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GameSabaRetryCheckReq) Reset() {
	*x = GameSabaRetryCheckReq{}
	mi := &file_platform_v1_platform_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GameSabaRetryCheckReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameSabaRetryCheckReq) ProtoMessage() {}

func (x *GameSabaRetryCheckReq) ProtoReflect() protoreflect.Message {
	mi := &file_platform_v1_platform_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameSabaRetryCheckReq.ProtoReflect.Descriptor instead.
func (*GameSabaRetryCheckReq) Descriptor() ([]byte, []int) {
	return file_platform_v1_platform_proto_rawDescGZIP(), []int{20}
}

type GameSabaRetryCheckResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GameSabaRetryCheckResp) Reset() {
	*x = GameSabaRetryCheckResp{}
	mi := &file_platform_v1_platform_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GameSabaRetryCheckResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameSabaRetryCheckResp) ProtoMessage() {}

func (x *GameSabaRetryCheckResp) ProtoReflect() protoreflect.Message {
	mi := &file_platform_v1_platform_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameSabaRetryCheckResp.ProtoReflect.Descriptor instead.
func (*GameSabaRetryCheckResp) Descriptor() ([]byte, []int) {
...
const file_platform_v1_platform_proto_rawDesc = "" +
	...
	"isMaterial\x12\x1d\n" +
	"\n" +
	"return_url\x18\x0e \x01(\tR\treturnUrl\x12(\n" +
	"\x10merchant_user_id\x18\x0f \x01(\tR\x0emerchantUserId\"#\n" +
	...
	"\x06amount\x18\x02 \x01(\tR\x06amount\"\x9e\x01\n" +
	...
	"\x04page\x18\x04 \x01(\x03R\x04page\x12\x18\n" +
	"\ahistory\x18\x05 \x01(\bR\ahistory\"}\n" +
	...
	"\x11GameSabaStatusReq\x12\x14\n" +
	"\x05refId\x18\x01 \x03(\tR\x05refId\"\x14\n" +
	"\x12GameSabaStatusResp\"\x17\n" +
	"\x15GameSabaRetryCheckReq\"\x18\n" +
	"\x16GameSabaRetryCheckResp\"7\n" +
	...
	"\x11SyncProviderGames\x12!.platform.v1.SyncProviderGamesReq\x1a\x19.platform.v1.PlatformResp\x12V\n" +
	"\x13GameSabaStatusCheck\x12\x1e.platform.v1.GameSabaStatusReq\x1a\x1f.platform.v1.GameSabaStatusResp\x12]\n" +
	"\x12GameSabaRetryCheck\x12\".platform.v1.GameSabaRetryCheckReq\x1a#.platform.v1.GameSabaRetryCheckRespB8Z6github.com/og-game/game-proto/proto-gen-go/platform/v1b\x06proto3"
...
var file_platform_v1_platform_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_platform_v1_platform_proto_goTypes = []any{
	...
	(*GameSabaStatusReq)(nil),           // 18: platform.v1.GameSabaStatusReq
	(*GameSabaStatusResp)(nil),          // 19: platform.v1.GameSabaStatusResp
	(*GameSabaRetryCheckReq)(nil),       // 20: platform.v1.GameSabaRetryCheckReq
	(*GameSabaRetryCheckResp)(nil),      // 21: platform.v1.GameSabaRetryCheckResp
	(*SyncProviderGamesReq)(nil),        // 22: platform.v1.SyncProviderGamesReq
	(v1.TransferStatus)(0),              // 23: common.v1.TransferStatus
	(v1.GameState)(0),                   // 24: common.v1.GameState
	(v1.GameBetState)(0),                // 25: common.v1.GameBetState
	(v1.GameTransactionType)(0),         // 26: common.v1.GameTransactionType
}
var file_platform_v1_platform_proto_depIdxs = []int32{
	23, // 0: platform.v1.TransferResp.transfer_status:type_name -> common.v1.TransferStatus
	24, // 1: platform.v1.GameInfo.game_state:type_name -> common.v1.GameState
	25, // 2: platform.v1.GameInfo.bet_state:type_name -> common.v1.GameBetState
	8,  // 3: platform.v1.GetGameListResp.game_info:type_name -> platform.v1.GameInfo
	23, // 4: platform.v1.GetTransferRecordStatusResp.status:type_name -> common.v1.TransferStatus
	15, // 5: platform.v1.GetBetRecordListResp.data:type_name -> platform.v1.BetRecordListItem
	26, // 6: platform.v1.BetRecordListItem.status:type_name -> common.v1.GameTransactionType
	...
	22, // 15: platform.v1.PlatformInnerService.SyncProviderGames:input_type -> platform.v1.SyncProviderGamesReq
	18, // 16: platform.v1.PlatformInnerService.GameSabaStatusCheck:input_type -> platform.v1.GameSabaStatusReq
	20, // 17: platform.v1.PlatformInnerService.GameSabaRetryCheck:input_type -> platform.v1.GameSabaRetryCheckReq
	2,  // 18: platform.v1.PlatformInnerService.GetGameLink:output_type -> platform.v1.GetGameLinkResp
	2,  // 19: platform.v1.PlatformInnerService.GetDemoGameLink:output_type -> platform.v1.GetGameLinkResp
	4,  // 20: platform.v1.PlatformInnerService.GetUserBalance:output_type -> platform.v1.GetUserBalanceResp
	6,  // 21: platform.v1.PlatformInnerService.Transfer:output_type -> platform.v1.TransferResp
	10, // 22: platform.v1.PlatformInnerService.GetGameList:output_type -> platform.v1.GetGameListResp
	12, // 23: platform.v1.PlatformInnerService.GetTransferRecordStatus:output_type -> platform.v1.GetTransferRecordStatusResp
	14, // 24: platform.v1.PlatformInnerService.GetBetRecordList:output_type -> platform.v1.GetBetRecordListResp
	17, // 25: platform.v1.PlatformInnerService.GetGameHTML:output_type -> platform.v1.GetGameHTMLResp
	0,  // 26: platform.v1.PlatformInnerService.SyncProviderGames:output_type -> platform.v1.PlatformResp
	19, // 27: platform.v1.PlatformInnerService.GameSabaStatusCheck:output_type -> platform.v1.GameSabaStatusResp
	21, // 28: platform.v1.PlatformInnerService.GameSabaRetryCheck:output_type -> platform.v1.GameSabaRetryCheckResp
